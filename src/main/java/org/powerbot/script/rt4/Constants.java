...
public final class Constants {
	...
	public static final int GRAND_EXCHANGE_CREATE_OFFER_QUANTITY = getInt("GRAND_EXCHANGE_CREATE_OFFER_QUANTITY");
	public static final int GRAND_EXCHANGE_CREATE_OFFER_PRICE = getInt("GRAND_EXCHANGE_CREATE_OFFER_PRICE");
	public static final int CHAT_INPUT_ITEM = getInt("CHAT_INPUT_ITEM");
	public static final int GRAND_EXCHANGE_COLLECT_BUTTON_COMPONENT = getInt("GRAND_EXCHANGE_COLLECT_BUTTON_COMPONENT");
	public static final int GRAND_EXCHANGE_COLLECT_BUTTON_CHILD = getInt("GRAND_EXCHANGE_COLLECT_BUTTON_CHILD");
	public static final int GRAND_EXCHANGE_FIRST_OFFER_SLOT = getInt("GRAND_EXCHANGE_FIRST_OFFER_SLOT");
	public static final int COLLECTION_BOX_FIRST_OFFER_SLOT = getInt("COLLECTION_BOX_FIRST_OFFER_SLOT");
	public static final int COLLECTION_BOX_WIDGET_ID = getInt("COLLECTION_BOX_WIDGET_ID");
	public static final int CAN_COLLECT_ITEM_TEXT_COLOR = getInt("CAN_COLLECT_ITEM_TEXT_COLOR");
	public static final int GE_SLOT_ITEM_NAME = getInt("GE_SLOT_ITEM_NAME");
	public static final int GE_SLOT_ITEM = getInt("GE_SLOT_ITEM");
	public static final int GE_SLOT_BUY_OFFER_STATE = getInt("GE_SLOT_BUY_OFFER_STATE");
	public static final int GE_ABORTED_TEXT_COLOR = getInt("GE_ABORTED_TEXT_COLOR");
	public static final int GE_FINISHED_TEXT_COLOR = getInt("GE_FINISHED_TEXT_COLOR");
	public static final int GE_SLOT_PROGRESS_BAR = getInt("GE_SLOT_PROGRESS_BAR");
	public static final int GE_SLOT_PROGRESS_INFO_COMPONENT = getInt("GE_SLOT_PROGRESS_INFO_COMPONENT");
	public static final int GE_SLOT_PROGRESS_INFO_CHILD = getInt("GE_SLOT_PROGRESS_INFO_CHILD");
	public static final int GE_SLOT_PRICE_PER_ITEM = getInt("GE_SLOT_PRICE_PER_ITEM");
	public static final int GRAND_EXCHANGE_F2P_SLOTS = getInt("GRAND_EXCHANGE_F2P_SLOTS");
	public static final int GRAND_EXCHANGE_P2P_SLOTS = getInt("GRAND_EXCHANGE_P2P_SLOTS");
	public static final int GRAND_EXCHANGE_SEARCH_RESULT_COMPONENT = getInt("GRAND_EXCHANGE_SEARCH_RESULT_COMPONENT");
	public static final int GRAND_EXCHANGE_SEARCH_RESULT_SCROLL_BAR_COMPONENT = getInt("GRAND_EXCHANGE_SEARCH_RESULT_SCROLL_BAR_COMPONENT");
	public static final int GRAND_EXCHANGE_SEARCH_RESULT_SCROLL_BAR_CHILD = getInt("GRAND_EXCHANGE_SEARCH_RESULT_SCROLL_BAR_CHILD");
	public static final int GRAND_EXCHANGE_CANCEL_BUTTON = getInt("GRAND_EXCHANGE_CANCEL_BUTTON");
	public static final int GRAND_EXCHANGE_CONFIRM_OFFER_BUTTON = getInt("GRAND_EXCHANGE_CONFIRM_OFFER_BUTTON");
	public static final int GRAND_EXCHANGE_COLLECT_OFFER_ITEMS_COMPONENT = getInt("GRAND_EXCHANGE_COLLECT_OFFER_ITEMS_COMPONENT");
	public static final int GRAND_EXCHANGE_COLLECT_OFFER_ITEM_ONE = getInt("GRAND_EXCHANGE_COLLECT_OFFER_ITEM_ONE");
	public static final int GRAND_EXCHANGE_COLLECT_OFFER_ITEM_TWO = getInt("GRAND_EXCHANGE_COLLECT_OFFER_ITEM_TWO");
	public static final int GRAND_EXCHANGE_CUSTOM_PRICE_BUTTON = getInt("GRAND_EXCHANGE_CUSTOM_PRICE_BUTTON");
	public static final int GRAND_EXCHANGE_CUSTOM_QUANTITY_BUTTON = getInt("GRAND_EXCHANGE_CUSTOM_QUANTITY_BUTTON");
	public static final int COLLECTION_BOX_PROGRESS_COMPONENT = getInt("COLLECTION_BOX_PROGRESS_COMPONENT");
	public static final int COLLECTION_BOX_PROGRESS_CHILD = getInt("COLLECTION_BOX_PROGRESS_CHILD");
	public static final int COLLECTION_BOX_SLOT_ITEM = getInt("COLLECTION_BOX_SLOT_ITEM");
	public static final int COLLECTION_BOX_PROGRESS_BAR = getInt("COLLECTION_BOX_PROGRESS_BAR");
	public static final int COLLECTION_BOX_ITEM_ONE = getInt("COLLECTION_BOX_ITEM_ONE");
	public static final int COLLECTION_BOX_ITEM_TWO = getInt("COLLECTION_BOX_ITEM_TWO");
	public static final int COLLECTION_BOX_TO_INVENTORY_BUTTON_COMPONENT = getInt("COLLECTION_BOX_TO_INVENTORY_BUTTON_COMPONENT");
	public static final int COLLECTION_BOX_TO_INVENTORY_BUTTON_CHILD = getInt("COLLECTION_BOX_TO_INVENTORY_BUTTON_CHILD");
	public static final int COLLECTION_BOX_TO_BANK_BUTTON_COMPONENT = getInt("COLLECTION_BOX_TO_BANK_BUTTON_COMPONENT");
	public static final int COLLECTION_BOX_TO_BANK_BUTTON_CHILD = getInt("COLLECTION_BOX_TO_BANK_BUTTON_CHILD");

	public static final int GRAND_EXCHANGE_BUY_BUTTON = getInt("GRAND_EXCHANGE_BUY_BUTTON");
	public static final int GRAND_EXCHANGE_SELL_BUTTON = getInt("GRAND_EXCHANGE_SELL_BUTTON");
	...
	public static final int STORE_BOUNDARIES_COMPONENT_ID = getInt("STORE_BOUNDARIES_COMPONENT_ID");
	public static final int STORE_SHOPNAME_SUB_COMPONENT_ID = getInt("STORE_SHOPNAME_SUB_COMPONENT_ID");
	public static final int STORE_QUANTITY_VALUE_COMPONENT_ID = getInt("STORE_QUANTITY_VALUE_COMPONENT_ID");
	public static final int STORE_QUANTITY_ONE_COMPONENT_ID = getInt("STORE_QUANTITY_ONE_COMPONENT_ID");
	public static final int STORE_QUANTITY_FIVE_COMPONENT_ID = getInt("STORE_QUANTITY_FIVE_COMPONENT_ID");
	public static final int STORE_QUANTITY_TEN_COMPONENT_ID = getInt("STORE_QUANTITY_TEN_COMPONENT_ID");
